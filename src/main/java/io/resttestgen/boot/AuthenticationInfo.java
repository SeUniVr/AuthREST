...
public class AuthenticationInfo {
    ...
    public boolean authenticate() {
        ...
        try {
            ...
            logger.warn("Could not execute authentication script for '{}'. " + ignoredAuthInfoError, description);
            return false;
        }
        ...
        if (map.size() < 4 || !map.containsKey("name") || !map.containsKey("value") ||
            ...
            logger.warn("Authorization script must return a JSON containing all and only the following fields 'name', 'value', 'in', 'duration'. Instead, its result was: {}. " + ignoredAuthInfoError, map);
            return false;
        }
